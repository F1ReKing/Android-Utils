...
public class CalenderUtils {
    ...
    private static String[] daysOfAlmanac = {
     ...
     * @return String
     */
    public static String getChineseDay(int y, int m, int d) {
        CalenderUtils c = new CalenderUtils();
     ...
     * 要判断闰月 月初 月末
     */
    public static String getChineseMonth(int y, int m, int d) {
        setGregorian(y, m, d);
    ...
    public String[] getYearTable() {
        ...
        table[1] = getTextLine(27,
            "农历年历：" + (chineseYear + 1) + " (" + stemNames[(chineseYear + 1 - 1) % 10] + branchNames[(chineseYear + 1
                - 1) % 12] + " - " + animalNames[(chineseYear + 1 - 1) % 12] + "年)");
        int ln = 2;
        String blank = "                                         " + "  " + "                                         ";
        String[] mLeft = null;
        String[] mRight = null;
    ...
    private static String[] principleTermNames = {
        "雨水", "春分", "谷雨", "夏满", "夏至", "大暑", "处暑", "秋分", "霜降", "小雪", "冬至", "大寒"
    };
    ...
    public static int getChineseMonth() {
        return chineseMonth;
    }
    ...
    public static void setDaysInGregorianMonth(char[] daysInGregorianMonth) {
        CalenderUtils.daysInGregorianMonth = daysInGregorianMonth;
    }
    ...
    public static void setStemNames(String[] stemNames) {
        CalenderUtils.stemNames = stemNames;
    }
    ...
    public static void setBranchNames(String[] branchNames) {
        CalenderUtils.branchNames = branchNames;
    }
    ...
    public static void setAnimalNames(String[] animalNames) {
        CalenderUtils.animalNames = animalNames;
    }
    ...
    public static void setChineseMonths(char[] chineseMonths) {
        CalenderUtils.chineseMonths = chineseMonths;
    }
    ...
    public static void setBaseYear(int baseYear) {
        CalenderUtils.baseYear = baseYear;
    }
    ...
    public static void setBaseMonth(int baseMonth) {
        CalenderUtils.baseMonth = baseMonth;
    }
    ...
    public static void setBaseDate(int baseDate) {
        CalenderUtils.baseDate = baseDate;
    }
    ...
    public static void setBaseIndex(int baseIndex) {
        CalenderUtils.baseIndex = baseIndex;
    }
    ...
    public static void setBaseChineseYear(int baseChineseYear) {
        CalenderUtils.baseChineseYear = baseChineseYear;
    }
    ...
    public static void setBaseChineseMonth(int baseChineseMonth) {
        CalenderUtils.baseChineseMonth = baseChineseMonth;
    }
    ...
    public static void setBaseChineseDate(int baseChineseDate) {
        CalenderUtils.baseChineseDate = baseChineseDate;
    }
    ...
    public static void setBigLeapMonthYears(int[] bigLeapMonthYears) {
        CalenderUtils.bigLeapMonthYears = bigLeapMonthYears;
    }
    ...
    public static void setSectionalTermMap(char[][] sectionalTermMap) {
        CalenderUtils.sectionalTermMap = sectionalTermMap;
    }
    ...
    public static void setSectionalTermYear(char[][] sectionalTermYear) {
        CalenderUtils.sectionalTermYear = sectionalTermYear;
    }
    ...
    public static void setPrincipleTermMap(char[][] principleTermMap) {
        CalenderUtils.principleTermMap = principleTermMap;
    }
    ...
    public static void setPrincipleTermYear(char[][] principleTermYear) {
        CalenderUtils.principleTermYear = principleTermYear;
    }
    ...
    public static void setMonthNames(String[] monthNames) {
        CalenderUtils.monthNames = monthNames;
    }
    ...
    public static void setChineseMonthNames(String[] chineseMonthNames) {
        CalenderUtils.chineseMonthNames = chineseMonthNames;
    }
    ...
    public static void setPrincipleTermNames(String[] principleTermNames) {
        CalenderUtils.principleTermNames = principleTermNames;
    }
    ...
    public static void setSectionalTermNames(String[] sectionalTermNames) {
        CalenderUtils.sectionalTermNames = sectionalTermNames;
    }
}
