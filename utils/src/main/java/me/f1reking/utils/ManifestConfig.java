...
public class ManifestConfig {
     ...
     */
    @SuppressWarnings("unchecked") private static <T> T getMetaValue(Context context, String metaKey, Class<T> cls) {
        ...
        try {
            ...
            throw new RuntimeException("Undefined meta-data which named " + metaKey + " in AndroidManifest");
        }
        return null;
    }
